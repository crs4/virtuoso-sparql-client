...
TestClient.setDefaultGraph("https://w3id.org/test");
...
TestClient.getLocalStore().add(
  new Triple(
    new Node("ciaoGrande3"),
    "rdfs:label",
    new Text(variables, "CZ"),
    Triple.ADD
  )
);
TestClient.store(false)
.then((result)=>{
